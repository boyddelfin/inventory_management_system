        ...
        <div class="col-12">
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                    <li><a class="dropdown-item" href="<?php echo _url('products/category'); ?>">Product Category</a></li>
                    <li><a class="dropdown-item" href="<?php echo _url('products/category'); ?>">Category</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="<?php assets_img_url('team-3.jpg'); ?>"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="<?php assets_img_url('team-4.jpg'); ?>"
